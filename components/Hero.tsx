export default function Hero() {
  return (
    <div className="w-full flex flex-col items-center justify-center h-screen text-center bg-black text-white">
      <iframe
      ...
      <div className="max-w-3xl xl:max-w-full mx-auto mb-20 lg:mb-0">
        <h1 className="z-10 xl:px-20 relative text-5xl lg:text-8xl leading-[1.1em] tracking-tight">
          The world is a home to many great places to discover.
        </h1>
        <p className="hidden lg:block text-lg max-w-xl xl:max-w-4xl xl:text-2xl z-30 relative tracking-wider leading-[1.5em] font-black mx-auto mt-4 xl:mt-10 mb-10 drop-shadow-2xl filter">
      ...
      <div className="z-10 relative flex flex-col lg:flex-row gap-4 before:lg:gap-8 justify-center">
